...
foreach($markets as $mkt){
	...
	echo "<td class='account-mkt-usdbal' id='account-mkt-usdbal-{$mname}' data-usdbal='{$usdbal}'>{$usd}</td>";
	echo "<td class='account-mkt-usd2btc' id='account-mkt-usd2btc-{$mname}'>...</td>";
	echo "<td class='account-mkt-btcbal' id='account-mkt-btcbal-{$mname}' data-btcbal='{$btcbal}'>{$btc}</td>";
...
echo "<td class='account-mkt-usdbal' id='account-mkt-usdbal-total'>\${$totalusdbal}</td>";
echo "<td class='account-mkt-usd2btc' id='account-mkt-usd2btc-total'>...</td>";
echo "<td class='account-mkt-btcbal' id='account-mkt-btcbal-total'>{$totalbtcbal} BTC</td>";
